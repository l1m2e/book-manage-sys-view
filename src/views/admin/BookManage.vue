<template>
  <el-row
    style="background-color: #FFFFFF;padding: 20px 0;border-radius: 5px;width: 1200px;margin: 0 auto;"
  >
        ...
        >
          <div class="item-book">
            <div style="display: flex;justify-content: center;">
              <img
                style="width: 150px;max-height: 180px;border-radius: 5px;"
                :src="book.cover"
                alt=""
              />
            </div>
        ...
        <el-row>
          <el-col :span="8">
            ...
            <!-- <div v-if="!isOperation || data.isPlanBuy">
                            <p>上线只需要设置为未预售即可</p>
                            <div style="margin-bottom: 8px;">
                                <div class="point">*是否为预售新闻(预售才选)</div>
