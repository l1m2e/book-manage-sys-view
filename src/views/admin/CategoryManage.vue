  ...
  <el-row style="background-color: #FFFFFF;padding: 20px 0;border-radius: 5px;">
    ...
    <el-row style="margin: 10px 20px;">
      <el-table :data="tableData">
        <el-table-column prop="name" label="新闻类别名"></el-table-column>
  ...
  methods: {
    ...
    updateOperation() {
      this.$axios
        ...
        .catch(error => {
          this.$message.error("新闻修改异常：" + error);
          console.log("新闻修改异常：", error);
        });
    },
    resetValue(v1, v2) {
      this.isOperation = v1;
    ...
    addOperation() {
      this.$axios
        ...
        .catch(error => {
          this.$message.error("新闻新增异常：" + error);
          console.log("新闻新增异常：", error);
        });
    },
